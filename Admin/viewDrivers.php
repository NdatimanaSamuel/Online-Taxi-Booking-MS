                             ...
                             $count = mysqli_num_rows($query);
                                ...
                                <div class="nav-item has-sub active open">
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="viewDrivers.php" class="menu-item active">View Drivers</a>
                ...
                <div class="main-content">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header d-block">
                                      ...
                                      <form>
                                        <div class="input-group" style="margin-left: 850px; width: 180px;margin-top: 10px;">
                                          <input type="search" id="myInput" onkeyup="myFunction()"  placeholder="Search by Driver Names.." class="form-control" />
                    ...
                    <table id="tablepaging" class="table table-striped table-bordered nowrap">
                         ...
                         $conn=mysqli_connect("localhost","root","", "taxibookdb") or die(mysql_error());
                          $no=0;
                         $query = $conn->query("SELECT * FROM `driverdb`  ORDER BY driverid DESC") or die(mysqli_error());
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><?php echo $no ;?></td>
                                                            ...
                                                            <td><?php echo $fetch['driveremail']?></td>
                                                           
                                                            <td><?php echo $fetch['drivercategory']?></td>
                                                            <td><?php echo $fetch['driveridnumber']?></td>
                                                            <td><?php echo $fetch['driverstatus']?></td>
                                                        <td>
                                                           <!--  <a href="#"><i class="ik ik-eye"></i></a> -->
                                                            <a href="editDriver.php?id=<?php echo $fetch['driverid']?>"><i class="ik ik-edit-2"></i></a>
                                                            <a href="deleteDriver.php?id=<?php echo $fetch['driverid']?>" onclick="return confirm('are you sure you want to delete')"><i class="ik ik-trash-2"></i></a>
                                                        </td>
                                                    </tr>
