                                ...
                                <div class="nav-item">
                                 ...
                                 <div class="nav-item has-sub active open">
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="viewTaxi.php" class="menu-item active">View Taxi</a>
                        ...
                        while($fetch = $query->fetch_array()){
                         ...
                         ?> 
                                                <tbody>
                                                    <tr>
                                                         <td><?php echo $no ;?></td>
                                                        <td><?php echo $fetch['taxiname']?></td>
                                                         <td><?php echo $fetch['taxiplate']?></td>
                                                        <td><?php echo $fetch['taxiseats']?></td>
                                                         <td><img src = "photo/<?php echo $fetch['taxiimage']?>" height = "50" width = "50"/></td>
                                                            <td><?php echo $fetch['taxiprice']?> Frw</td>
                                                          <!--   <td><?php echo $fetch['taxidescription']?></td> -->
                                                            <td><?php echo $fetch['taxistatus']?></td>
                                                             <td><?php echo $fetch['taxiaddedon']?></td>
                                                        <td>
                                                           <!--  <a href="#"><i class="ik ik-eye"></i></a> -->
                                                            <a href="editTaxi.php?id=<?php echo $fetch['taxiid']?>"><i class="ik ik-edit-2"></i></a>
                                                            <a href="deleteTaxi.php?id=<?php echo $fetch['taxiid']?>"><i class="ik ik-trash-2"></i></a>
                                                        </td>
                                                    </tr>
