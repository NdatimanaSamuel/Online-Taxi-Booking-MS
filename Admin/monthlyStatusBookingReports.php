                                  ...
                                  <div class="nav-item has-sub active open">
                                    ...
                                    <div class="submenu-content">
                                        <a href="dailyBookingReports.php" class="menu-item ">Daily Reports</a>
                                         ...
                                         <a href="monthlyStatusBookingReports.php" class="menu-item active">Monthly Status Reports</a>
                                    </div>
                                </div>
                ...
                <div class="main-content">
                    <div class="container-fluid">
                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="#">Monthly Status Booking</a>
                                            </li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Monthly Status Booking Reports</h3></div>
                                    <div class="card-body">
                      ...
                      <label for="password" class="d-block">Select  Status</label>
                                               
                     <select id="inputState" class="form-control" name="statusbook" required="">
                              <option></option>
                              ...
                              <option>cancelled</option>                    
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <button type="submit" class="btn btn-primary">Filter</button>     <button type="button" class="btn btn-primary" onclick="print()" style="margin-left:100px;">Print</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header d-block">
                                        <h3>View All Monthly Status Booking</h3>
                                    </div>
                    ...
                    <table id="tablepaging" class="table table-striped table-bordered nowrap">
                                ...
                                if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                {
                                    ...
                                    $to_date = $_GET['to_date'];
                                      $statusbooks = $_GET['statusbook'];

                                    $query = "SELECT * FROM bookingtb WHERE customerbookedon BETWEEN '$from_date' AND '$to_date' AND  status='$statusbooks' ";
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $row)
                                        {
                                            ...
                                            ?>
                                                ...
                                                <td><?= $row['taxiplates']; ?></td>
                                                <td><?= $row['taxiprices']; ?></td>
                                                <td><?= $row['customername']; ?></td>
                                                <td><?= $row['customeremail']; ?></td>
                                                <td><?= $row['customerphone']; ?></td>
                                                        <td>
                                                            <a href="viewCompletedBookingDetails.php?id=<?php echo $row['bookingid']?>"><i class="ik ik-eye"></i></a>
                                    ...
                                    {
                                        echo "<div style='color:red; align='center';'>No Record Found</div>";
                                    }
                                }
                            ?>
                                                </tbody>
