                                    ...
                                    <div class="submenu-content">
                                        <a href="dailyBookingReports.php" class="menu-item ">Daily Reports</a>
                                         <a href="monthlyBookingReports.php" class="menu-item">Monthly Reports</a>
                                           <a href="dailyStatusBookingReports.php" class="menu-item active">Daily Status Reports</a>
                ...
                <div class="main-content">
                    <div class="container-fluid">
                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="#">Daily Status Booking Reports</a>
                                            </li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Daily Status Booking Reports</h3></div>
                                    <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header d-block">
                                        <h3>View All Daily Status Booking</h3>
                                    </div>
                    ...
                    <table id="tablepaging" class="table table-striped table-bordered nowrap">
                                ...
                                if(isset($_GET['from_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM bookingtb WHERE customerbookedon='$from_date' AND   status='$statusbooks' ";
