<?php
require ("updateAcceptedBookingQuery.php");
?>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="page-wrap">
                        ...
                        <div class="nav-container">
                            ...
                            $query = mysqli_query($con, $count_query);
                             $count = mysqli_num_rows($query);
                                         ...
                                         <a href="viewCompletedBooking.php" class="menu-item">Completed Journey</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Accepted Booking Details</h4>
                  <!-- <p class="card-description">
                    Use the <code>.form-inline</code> class to display a series of labels, form controls, and buttons on a single horizontal row
                             ...
                             <?php
                                     ...
                                     $query = $conn->query("SELECT * FROM `bookingtb` WHERE `bookingid` ='$ID'") or die(mysqli_error());
                        ...
                        <div class="col-md-6">
                               <dl>
                        <dt class="text-muted">Booking Code</dt>
                        <dd class='pl-4 fs-4 fw-bold'><?php echo $fetch['bookingcode']?></dd>
                        <dt class="text-muted"> Name</dt>
                        <dd class='pl-4 fs-4 fw-bold'><?php echo $fetch['customername']?></dd>
                        <dt class="text-muted"> Taxi Price</dt>
                        <dd class='pl-4 fs-4 fw-bold'><?php echo $fetch['taxiprices']?> Frw</dd>
                        <dt class="text-muted">Taxi Plate</dt>
                        <dd class='pl-4 fs-4 fw-bold'><?php echo $fetch['taxiplates']?></dd>
                          <dt class="text-muted">Customer Email</dt>
                        <dd class='pl-4 fs-4 fw-bold'><?php echo $fetch['customeremail']?></dd>
                        <dt class="text-muted">Customer Phone</dt>
                        <dd class='pl-4 fs-4 fw-bold'><?php echo $fetch['customerphone']?></dd>
                        <dt class="text-muted">Customer Address</dt> <dd class='pl-4 text-dark'>
                          <?php echo $fetch['customeraddress']?> </dd>

                            <dt class="text-muted">Customer Gender</dt> <dd class='pl-4 text-dark'>
                          <?php echo $fetch['customergender']?> </dd>
                    ...
                    <dl>
                         ...
                         <dt class="text-muted">Customer Country</dt> <dd class='pl-4 text-dark'>
                          <?php echo $fetch['customercountry']?> </dd>

                          <dt class="text-muted">Customer Pick Up Address</dt> <dd class='pl-4 text-dark'>
                          <?php echo $fetch['customerpickupaddress']?> </dd>

                           <dt class="text-muted">Customer Drp Address</dt> <dd class='pl-4 text-dark'>
                          <?php echo $fetch['customerdropaddress']?> </dd>

                           <dt class="text-muted">Customer Start Date</dt> <dd class='pl-4 text-dark'>
                          <?php echo $fetch['customerstartdate']?> </dd>

                          <dt class="text-muted">Customer Start Time</dt> <dd class='pl-4 text-dark'>
                          <?php echo $fetch['customerstarttime']?> </dd>

                          <dt class="text-muted">Status</dt> <dd class='pl-4 text-dark'>
                          <?php echo $fetch['status']?> </dd>
                          <dt class="text-muted">Paying Status</dt> <dd class='pl-4 text-dark'>
                          <?php echo $fetch['paystatus']?> </dd>
                          <dt class="text-muted">Booked On</dt> <dd class='pl-4 text-dark'>
                          <?php echo $fetch['customerbookedon']?> </dd>
                        ...
                        <div class="row">
                            ...
                            <div class="card-header d-block">
                                        <h3>Update Accepted Taxis</h3>
                                        
                                                <p class="error prifceee-error" style="color: red;background-color: #fde8ec;">
                                                      <!-- error message -->
                                             <?php echo $driverNamePIdExiIsExist;?>
                                              </p>

                                              <p class="error pridfceee-error" style="color: red;background-color: #fde8ec;">
                                                      <!-- error message -->
                                             <?php echo $driverNpPIdExiIsExist;?>
                                              </p>

                                               <p class="error prsidfceee-error" style="color: red;background-color: #fde8ec;">
                                                      <!-- error message -->
                                             <?php echo $driverNpPIdLonExiIsExist;?>
                                              </p>
                            </div>
                                        ...
                                        <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="bookngid" value="<?php echo $fetch['bookingid'] ;?>">
                                            <input type="hidden" name="taxidss" value="<?php echo $fetch['taxiid'] ;?>">

                                               <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail3">Driver Phone</label>
                                                        <input type="number" name="driverphone"  value="<?php echo $driverPhone;?>" class="form-control" id="exampleInputEmail3" placeholder="Driver Phone" required="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleSelectGender">Driver Email</label>
                                                            <select class="form-control" name="driveremails" required="">
                                                        
                                                        <option></option>

                                                        <?php
                                                       $conn = mysqli_connect("localhost","root","","taxibookdb");

                                                    $sqlQuery  = "select distinct driveremail from driverdb";
                                                       ...
                                                       ?>
                                                            <option value="<?php echo $row['driveremail']; ?>" ><?php echo $row['driveremail']; ?> </option>
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputName1">Status</label>
                                                 <select class="form-control" name="bookingtaxistatus" id="exampleSelectGender" required="">
                                                            <option></option>
                                           ...
                                           <!--  <div class="form-group">
                                            ...
                                            <button type="submit" name="savetaxisupdate" class="btn btn-primary mr-2">Save Changes</button>
