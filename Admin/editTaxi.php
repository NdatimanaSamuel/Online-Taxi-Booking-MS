                ...
                <div class="main-content">
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Update Exist Taxi</h5>
                                            <span>Modify Exist taxi</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                          ...
                                          <!--   <li class="breadcrumb-item " aria-current="page">Add New Taxi</li> -->
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                   ...
                   <!--          <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Update Exist Taxi </h3></div>
                                     ...
                                     $fetch = $query->fetch_array();
                                      ?>
                                        ...
                                        <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                              <input type="hidden" name="taxiidd"  value="<?php echo $fetch['taxiid']?>">
                                            <div class="form-group">
                                                <label for="exampleInputName1">Taxi Name</label>
                                                <input type="text" name="taxinames" value="<?php echo $fetch['taxiname']?>" class="form-control" id="exampleInputName1" placeholder="Taxi Name " required="">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail3">Taxi Plate</label>
                                                        <input type="text" name="taxiplates"  value="<?php echo $fetch['taxiplate']?>" class="form-control" id="exampleInputEmail3" placeholder="Taxi Plate" required="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleSelectGender">Taxi Seats</label>
                                                        <input type="number" name="taxiseats"  value="<?php echo $fetch['taxiseats']?>" class="form-control" id="exampleInputEmail3" placeholder="Taxi Seats" required="">
                                                    </div>
                                                </div>
                                            </div>
                                                 <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail3">Taxi Price</label>
                                                        <input type="number" name="taxipries"  value="<?php echo $fetch['taxiprice']?>" class="form-control" id="exampleInputEmail3" placeholder="Taxi Price" required="">
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleSelectGender">Staus</label>
                                                        <select class="form-control" name="taxistatus" id="exampleSelectGender" required="">
                                                            <option></option>
                                           ...
                                           <!--  <div class="form-group">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <img src = "photo/<?php echo $fetch['taxiimage']?>" id = "lbl" width = "100%" height = "100%"/>
                                               </div><br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="descrip" id="exampleTextarea1" rows="4"><?php echo $fetch['taxidescription']?></textarea>
                                            </div>
                                            <button type="submit" name="savetaxis" class="btn btn-primary mr-2">Submit</button>
                                         <!--    <button class="btn btn-light">Cancel</button> -->
                                        </form>
                                    </div>
                                </div>
