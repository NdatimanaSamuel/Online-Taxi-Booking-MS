            ...
            <div class="page-wrap">
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="homeManager.php">
                            <div class="logo-img">
                ...
                <div class="card-body">
                  ...
                  <!-- <p class="card-description">
                    ...
                    <dl>
                       ...
                       <dt class="text-muted">Used Time</dt>
                        <dd class='pl-4 text-dark'><?php echo $fetch['usedtime']?> Hours</dd>
                        <dt class="text-muted">Total Paid</dt>
                        <dd class='pl-4 text-dark'><?php echo $fetch['totalpaid']?> Frw</dd>

                        <dt class="text-muted">Completed On</dt>
                        <dd class='pl-4 text-dark'><?php echo $fetch['completedon']?></dd>
