<?php
require ("updateTaxiBookingQuery.php");
?>
                    ...
                    <dl>
                        ...
                        <div class="row">
                            ...
                            <div class="card-header d-block">
                                        ...
                                        <input type="hidden" name="custoname" value="<?php echo $fetch['customername']?>">

                                         <input type="hidden" name="custophone" value="<?php echo $fetch['customerphone']?>">
                                           ...
                                           <!--  <div class="form-group">
                                            ...
                                            <button type="submit" name="savetaxisupdate" class="btn btn-primary mr-2">Submit</button>
