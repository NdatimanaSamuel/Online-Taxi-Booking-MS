                            ...
                            $query = mysqli_query($con, $count_query);
                             $count = mysqli_num_rows($query);
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="viewStartedJourney.php" class="menu-item active">
                ...
                <div class="main-content">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header d-block">
                                        <h3>View All Started Booking</h3>
                                    </div>
                    ...
                    <table id="tablepaging" class="table table-striped table-bordered nowrap">
                         ...
                         $conn=mysqli_connect("localhost","root","", "taxibookdb") or die(mysql_error());
                          $no=0;
                         $query = $conn->query("SELECT * FROM `bookingtb` WHERE status='started' AND paystatus='Not Paid' ORDER BY bookingid DESC") or die(mysqli_error());
                         ...
                         ?> 
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="viewStartedBookingDetails.php?id=<?php echo $fetch['bookingid']?>"><i class="ik ik-eye"></i></a>
