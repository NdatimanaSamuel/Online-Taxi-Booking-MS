                            ...
                            $query = mysqli_query($con, $count_query);
                             $count = mysqli_num_rows($query);
                                ...
                                <div class="nav-item has-sub active open">
                                    ...
                                    <div class="submenu-content">
                                        <a href="addDrivers.php" class="menu-item active">Add Drivers</a>
                ...
                <div class="main-content">
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Add New Drivers</h5>
                                            <span>register new Drivers</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item " aria-current="page">Add New Drivers</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                   ...
                   <!--          <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Add New Drivers </h3></div>
                                     <p class="error taxiameexist-error" style="color: red;background-color: #fde8ec;">
                                                                          <!-- error message -->
                                         <?php echo $driverExiIsExist;?>
                                          </p>

                                           <p class="error seaterr-error" style="color: red;background-color: #fde8ec;">
                                                      <!-- error message -->
                                             <?php echo $driverPhExiIsExist;?>
                                              </p>

                                              <p class="error priceee-error" style="color: red;background-color: #fde8ec;">
                                                      <!-- error message -->
                                             <?php echo $driverPIdExiIsExist;?>
                                              </p>
                                             ...
                                             <?php echo $driverNpPIdLonExiIsExist;?>
                                              ...
                                              <p class="error prsisdfceee-error" style="color: red;background-color: #fde8ec;">
                                                      <!-- error message -->
                                             <?php echo $driverNpPIdShonExiIsExist;?>
                                              </p>

                                              <p class="error prsisddsfceee-error" style="color: red;background-color: #fde8ec;">
                                                      <!-- error message -->
                                             <?php echo $driverNpPIdLonIdNumbExiIsExist;?>
                                              </p>
                                        ...
                                        <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="drivernames" value="<?php echo $driverNames;?>" class="form-control" id="exampleInputName1" placeholder="Driver Name " required="">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="driveremail"  value="<?php echo $driverEmail;?>" class="form-control" id="exampleInputEmail3" placeholder="Driver Email" required="">
                                                    </div>
                                                </div>
                                            </div>
                                                 <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail3">Driver Category</label>
                                                        <input type="text" name="drivercategory"  value="<?php echo $driverCategory;?>" class="form-control" id="exampleInputEmail3" placeholder="Driver Category" required="">
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleSelectGender">Id Number</label>
                                                         <input type="number" name="driverid"   value="<?php echo $driverId;?>" class="form-control" id="exampleInputEmail3" placeholder="Id Number" required="">
                                                    </div>
                                                </div>
                                            </div>
                                           <!--  <div class="form-group">
                                        ...
                                        <!--     <div class="form-group">
                                           ...
                                           <!--  <div class="form-group">
                                            ...
                                            <button type="submit" name="savetaxidriver" class="btn btn-primary mr-2">Submit</button>
                                         <!--    <button class="btn btn-light">Cancel</button> -->
                                        </form>
                                    </div>
                                </div>
