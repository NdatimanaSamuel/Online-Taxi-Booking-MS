                            ...
                            $query = mysqli_query($con, $count_query);
                             $count = mysqli_num_rows($query);
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="viewCancelledBooking.php" class="menu-item active">Cancelled Booking</a>
                ...
                <div class="main-content">
                    ...
                    <table id="tablepaging" class="table table-striped table-bordered nowrap">
                         ...
                         $conn=mysqli_connect("localhost","root","", "taxibookdb") or die(mysql_error());
                          $no=0;
                         $query = $conn->query("SELECT * FROM `bookingtb` WHERE status='cancelled' AND paystatus='Not Paid'") or die(mysqli_error());
