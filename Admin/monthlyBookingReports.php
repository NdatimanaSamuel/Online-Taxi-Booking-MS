                                  ...
                                  <div class="nav-item has-sub active open">
                                    ...
                                    <div class="submenu-content">
                                        <a href="dailyBookingReports.php" class="menu-item ">Daily Reports</a>
                                         <a href="monthlyBookingReports.php" class="menu-item active">Monthly Reports</a>
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Monthly Booking Reports</h3></div>
                                    <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header d-block">
                                        <h3>View All Monthly Booking</h3>
                                    </div>
                    ...
                    <table id="tablepaging" class="table table-striped table-bordered nowrap">
                                ...
                                if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM bookingtb WHERE customerbookedon BETWEEN '$from_date' AND '$to_date' ";
