                                ...
                                <div class="nav-item">
                                  ...
                                  <div class="nav-item has-sub active open">
                                    ...
                                    <div class="submenu-content">
                                        <a href="addTaxi.php" class="menu-item active">Add Taxi</a>
                ...
                <div class="main-content">
                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item " aria-current="page">Update Exist Drivers</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                   ...
                   <!--          <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Update Exist Drivers </h3></div>
                                     ...
                                     $query = $conn->query("SELECT * FROM `driverdb` WHERE `driverid` ='$id'") or die(mysqli_error());
                                     $fetch = $query->fetch_array();
                                      ?>
                                             <div class="card-body">
                                        <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                            <input type="hidden" value="<?php echo $fetch['driverid']?>" name="iddd">
                                            <div class="form-group">
                                                <label for="exampleInputName1">Driver Name</label>
                                                <input type="text" name="drivernames" value="<?php echo $fetch['drivernames']?>" class="form-control" id="exampleInputName1" placeholder="Driver Name " required="">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail3">Driver Phone</label>
                                                        <input type="number" name="driverphone"  value="<?php echo $fetch['driverphone']?>" class="form-control" id="exampleInputEmail3" placeholder="Driver Phone" required="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleSelectGender">Driver Email</label>
                                                        <input type="email" name="driveremail"   value="<?php echo $fetch['driveremail']?>" class="form-control" id="exampleInputEmail3" placeholder="Driver Email" required="">
                                                    </div>
                                                </div>
                                            </div>
                                                 <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="drivercategory"   value="<?php echo $fetch['drivercategory']?>"class="form-control" id="exampleInputEmail3" placeholder="Driver Category" required="">
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleSelectGender">Id Number</label>
                                                         <input type="number" name="driverid"  value="<?php echo $fetch['driveridnumber']?>" class="form-control" id="exampleInputEmail3" placeholder="Id Number" required="">
                                                    </div>
                                                </div>
                                            </div>
                                           <!--  <div class="form-group">
                                        ...
                                        <!--     <div class="form-group">
                                           ...
                                           <!--  <div class="form-group">
                                            ...
                                            <button type="submit" name="updatetaxidriver" class="btn btn-primary mr-2">Save Changes</button>
                                         <!--    <button class="btn btn-light">Cancel</button> -->
                                        </form>
                                    </div>
                                </div>
