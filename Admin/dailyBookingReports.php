                             ...
                             $count = mysqli_num_rows($query);
                                ...
                                <div class="nav-item has-sub">
                                  ...
                                  <div class="nav-item has-sub active open">
                                    ...
                                    <div class="submenu-content">
                                        <a href="dailyBookingReports.php" class="menu-item active">Daily Reports</a>
                ...
                <div class="main-content">
                    <div class="container-fluid">
                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="#">Daily Booking Reports</a>
                                            </li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Daily Booking Reports</h3></div>
                                    <div class="card-body">
                    ...
                    <table id="tablepaging" class="table table-striped table-bordered nowrap">
                                ...
                                if(isset($_GET['from_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM bookingtb WHERE customerbookedon='$from_date' ";
