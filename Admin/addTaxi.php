                                     ...
                                     <p class="error taxiameexist-error" style="color: red;background-color: #fde8ec;">
                                        ...
                                        <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="taxinames" class="form-control" id="exampleInputName1" placeholder="Taxi Name " required="">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail3">Taxi Plate</label>
                                                        <input type="text" name="taxiplates" class="form-control" id="exampleInputEmail3" placeholder="Taxi Plate" required="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleSelectGender">Taxi Seats</label>
                                                        <input type="number" name="taxiseats" class="form-control" id="exampleInputEmail3" placeholder="Taxi Seats" required="">
                                                    </div>
                                                </div>
                                            </div>
                                                 <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="taxipries" class="form-control" id="exampleInputEmail3" placeholder="Taxi Price" required="">
                                                    </div>
                                                </div>
