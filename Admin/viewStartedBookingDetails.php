<?php
require ("updateStartedBookingQuery.php");
?>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="page-wrap">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Started Booking Details</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="card-header d-block">
                                        ...
                                        <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="starttimes" value="<?php echo $fetch['customerstarttime'] ;?>">
                                            <input type="hidden" name="pricess" value="<?php echo $fetch['taxiprices'] ;?>">
